...
public class TestBillEntryE2 extends CoreBillEntryBase implements ITestBillEntryE2
{
    public TestBillEntryE2()
    {
        super();
        registerInterface(ITestBillEntryE2.class, this);
    }
    public TestBillEntryE2(Context ctx)
    {
        super(ctx);
        registerInterface(ITestBillEntryE2.class, this);
    }
    ...
    private TestBillEntryE2Controller getController() throws BOSException
    {
        return (TestBillEntryE2Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTestBillEntryE2Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTestBillEntryE2Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTestBillEntryE2Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTestBillEntryE2Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTestBillEntryE2Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTestBillEntryE2Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
