...
public class KsfcsBillEntryControllerBean extends AbstractKsfcsBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.bill.app.KsfcsBillEntryControllerBean");
}