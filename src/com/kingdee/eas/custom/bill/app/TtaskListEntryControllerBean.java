...
public class TtaskListEntryControllerBean extends AbstractTtaskListEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.bill.app.TtaskListEntryControllerBean");
}