 ...
 * output class name
 */
public class TlSlipListUI extends AbstractTlSlipListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TlSlipListUI.class);
    
    /**
     * output class constructor
     */
    public TlSlipListUI() throws Exception
    {
        super();
    }
