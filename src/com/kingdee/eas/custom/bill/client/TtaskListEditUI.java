 ...
 * output class name
 */
public class TtaskListEditUI extends AbstractTtaskListEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TtaskListEditUI.class);
    
    /**
     * output class constructor
     */
    public TtaskListEditUI() throws Exception
    {
        super();
    }
    /**
