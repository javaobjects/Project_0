...
public abstract class AbstractTlSlipEditUI extends com.kingdee.eas.st.common.client.STBillBaseEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contdescription, new KDLayout.Constraints(371, 56, 269, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(continstancy, new KDLayout.Constraints(10, 33, 270, 19, 0));
        contpayType.setBounds(new Rectangle(371, 33, 270, 19));
        this.add(contpayType, new KDLayout.Constraints(371, 33, 270, 19, 0));
        contcurrency.setBounds(new Rectangle(733, 33, 270, 19));
        this.add(contcurrency, new KDLayout.Constraints(733, 33, 270, 19, 0));
        contexchageRate.setBounds(new Rectangle(10, 56, 270, 19));
        this.add(contexchageRate, new KDLayout.Constraints(10, 56, 270, 19, 0));
        contcreateDate.setBounds(new Rectangle(371, 569, 270, 19));
        this.add(contcreateDate, new KDLayout.Constraints(371, 569, 270, 19, 0));
        contlastUpdateDate.setBounds(new Rectangle(4, 596, 270, 19));
        this.add(contlastUpdateDate, new KDLayout.Constraints(4, 596, 270, 19, 0));
        contauditDate.setBounds(new Rectangle(738, 596, 270, 19));
        this.add(contauditDate, new KDLayout.Constraints(738, 596, 270, 19, 0));
        //contbillStatus
