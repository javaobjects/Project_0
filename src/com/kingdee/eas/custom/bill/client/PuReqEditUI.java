 ...
 * output class name
 */
public class PuReqEditUI extends AbstractPuReqEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PuReqEditUI.class);
    
    /**
     * output class constructor
     */
    public PuReqEditUI() throws Exception
    {
        super();
    }
    /**
