 ...
 * output class name
 */
public class KsfcsBillListUI extends AbstractKsfcsBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(KsfcsBillListUI.class);
    
    /**
     * output class constructor
     */
    public KsfcsBillListUI() throws Exception
    {
        super();
    }
