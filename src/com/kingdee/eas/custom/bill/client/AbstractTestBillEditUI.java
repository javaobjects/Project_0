 ...
 * output class name
 */
public abstract class AbstractTestBillEditUI extends com.kingdee.eas.st.common.client.STBillBaseEditUI
{
    ...
    protected com.kingdee.eas.custom.bill.TestBillInfo editData = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        KDTextField kdtEntry_BIMUDF0001_TextField = new KDTextField();
        kdtEntry_BIMUDF0001_TextField.setName("kdtEntry_BIMUDF0001_TextField");
        kdtEntry_BIMUDF0001_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntry_BIMUDF0001_CellEditor = new KDTDefaultCellEditor(kdtEntry_BIMUDF0001_TextField);
        this.kdtEntry.getColumn("BIMUDF0001").setEditor(kdtEntry_BIMUDF0001_CellEditor);
        KDTextField kdtEntry_BIMUDF0002_TextField = new KDTextField();
        kdtEntry_BIMUDF0002_TextField.setName("kdtEntry_BIMUDF0002_TextField");
        kdtEntry_BIMUDF0002_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntry_BIMUDF0002_CellEditor = new KDTDefaultCellEditor(kdtEntry_BIMUDF0002_TextField);
        this.kdtEntry.getColumn("BIMUDF0002").setEditor(kdtEntry_BIMUDF0002_CellEditor);
        // contstorageOrgUnit		
        ...
        // kdtE2
		String kdtE2StrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:NumberFormat>&amp;int</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"BIMUDF0003\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seq}</t:Cell><t:Cell>$Resource{BIMUDF0003}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtE2.setFormatXml(resHelper.translateString("kdtE2",kdtE2StrXML));

                this.kdtE2.putBindContents("editData",new String[] {"E2.seq","E2.BIMUDF0003"});
        ...
        KDTextField kdtE2_BIMUDF0003_TextField = new KDTextField();
        kdtE2_BIMUDF0003_TextField.setName("kdtE2_BIMUDF0003_TextField");
        kdtE2_BIMUDF0003_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtE2_BIMUDF0003_CellEditor = new KDTDefaultCellEditor(kdtE2_BIMUDF0003_TextField);
        this.kdtE2.getColumn("BIMUDF0003").setEditor(kdtE2_BIMUDF0003_CellEditor);
        // billStatus		
        ...
        this.prmtstorageOrgUnit.setRequired(true);
        		setOrgF7(prmtstorageOrgUnit,com.kingdee.eas.basedata.org.OrgType.getEnum("Storage"));
    ...
    public void initUIContentLayout()
    {
        ...
        contbillStatus.setBounds(new Rectangle(733, 32, 270, 19));
        this.add(contbillStatus, new KDLayout.Constraints(733, 32, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contbizDate.setBounds(new Rectangle(733, 10, 270, 19));
        this.add(contbizDate, new KDLayout.Constraints(733, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdescription.setBounds(new Rectangle(11, 32, 643, 19));
        this.add(contdescription, new KDLayout.Constraints(11, 32, 643, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntry.setBounds(new Rectangle(12, 67, 993, 239));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.custom.bill.TestBillEntryInfo(),null,false);
        this.add(kdtEntry_detailPanel, new KDLayout.Constraints(12, 67, 993, 239, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contstorageOrgUnit.setBounds(new Rectangle(371, 10, 270, 19));
        this.add(contstorageOrgUnit, new KDLayout.Constraints(371, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtE2.setBounds(new Rectangle(12, 317, 993, 239));
        kdtE2_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtE2,new com.kingdee.eas.custom.bill.TestBillEntryE2Info(),null,false);
        this.add(kdtE2_detailPanel, new KDLayout.Constraints(12, 317, 993, 239, KDLayout.Constraints.ANCHOR_TOP_SCALE));
        //contbillStatus
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entries", com.kingdee.eas.custom.bill.TestBillEntryInfo.class, this.kdtEntry, "userObject");
		dataBinder.registerBinding("entries.BIMUDF0001", String.class, this.kdtEntry, "BIMUDF0001.text");
		dataBinder.registerBinding("entries.BIMUDF0002", String.class, this.kdtEntry, "BIMUDF0002.text");
		dataBinder.registerBinding("entries.E2.seq", int.class, this.kdtE2, "seq.text");
		dataBinder.registerBinding("entries.E2", com.kingdee.eas.custom.bill.TestBillEntryE2Info.class, this.kdtE2, "userObject");
		dataBinder.registerBinding("entries.E2.BIMUDF0003", String.class, this.kdtE2, "BIMUDF0003.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.bill.app.TestBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.bill.TestBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entries.BIMUDF0001", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.BIMUDF0002", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.E2.seq", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.E2", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.E2.BIMUDF0003", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entries.BIMUDF0001"));
    	sic.add(new SelectorItemInfo("entries.BIMUDF0002"));
    	sic.add(new SelectorItemInfo("entries.E2.seq"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entries.E2.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entries.E2.id"));
		}
    	sic.add(new SelectorItemInfo("entries.E2.BIMUDF0003"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.bill.client", "TestBillEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.bill.client.TestBillEditUI.class.getName();
    }
