 ...
 * output class name
 */
public class PuReqListUI extends AbstractPuReqListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PuReqListUI.class);
    
    /**
     * output class constructor
     */
    public PuReqListUI() throws Exception
    {
        super();
    }
