...
public class ChitCostPropertyCost extends CoreBillEntryBase implements IChitCostPropertyCost
{
    public ChitCostPropertyCost()
    {
        super();
        registerInterface(IChitCostPropertyCost.class, this);
    }
    public ChitCostPropertyCost(Context ctx)
    {
        super(ctx);
        registerInterface(IChitCostPropertyCost.class, this);
    }
    ...
    private ChitCostPropertyCostController getController() throws BOSException
    {
        return (ChitCostPropertyCostController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChitCostPropertyCostInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChitCostPropertyCostInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChitCostPropertyCostInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChitCostPropertyCostCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChitCostPropertyCostCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChitCostPropertyCostCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
