 ...
 * output class name
 */
public class ChitCostListUI extends AbstractChitCostListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChitCostListUI.class);
    
    /**
     * output class constructor
     */
    public ChitCostListUI() throws Exception
    {
        super();
    }
