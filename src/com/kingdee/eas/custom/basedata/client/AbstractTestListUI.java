 ...
 * output class name
 */
public abstract class AbstractTestListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTestListUI.class);
		...
		public AbstractTestListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.basedata.app.TestListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.basedata.client", "TestListUI");
    }
