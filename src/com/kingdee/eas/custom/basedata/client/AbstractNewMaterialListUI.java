 ...
 * output class name
 */
public abstract class AbstractNewMaterialListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNewMaterialListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractNewMaterialListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractNewMaterialListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.basedata.app.NewMaterialListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("materialModel"));
        sic.add(new SelectorItemInfo("materialCd"));
        return sic;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.basedata.client", "NewMaterialListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.basedata.client.NewMaterialEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.basedata.NewMaterialFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.basedata.NewMaterialInfo objectValue = new com.kingdee.eas.custom.basedata.NewMaterialInfo();		
        return objectValue;
    }
