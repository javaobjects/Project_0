 ...
 * output class name
 */
public class ChitCostEditUI extends AbstractChitCostEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChitCostEditUI.class);
    
    /**
     * output class constructor
     */
    public ChitCostEditUI() throws Exception
    {
        super();
    }
    /**
