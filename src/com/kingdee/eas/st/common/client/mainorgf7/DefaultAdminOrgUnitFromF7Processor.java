...
public class DefaultAdminOrgUnitFromF7Processor implements IF7Processor {
	private KDBizPromptBox f7 = null;

	public DefaultAdminOrgUnitFromF7Processor(KDBizPromptBox f7) {
		super();
		this.f7 = f7;
	}
	...
	public void mainOrgChanged(OrgUnitInfo oldOrg, OrgUnitInfo newOrg,
		...
		if (STUtils.isNotNull(newOrg) && STUtils.isNotNull(f7)) {
			...
			OrgUnitClientUtils.setBizOrgF7ByFromUnit(f7, OrgType.Admin,
