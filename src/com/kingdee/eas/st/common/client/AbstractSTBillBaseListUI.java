 ...
 * output class name
 */
public abstract class AbstractSTBillBaseListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSTBillBaseListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDSeparator separatorAudit;
     ...
     */
    public AbstractSTBillBaseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSTBillBaseListUI.class.getName());
        ...
        getActionManager().registerAction("actionMultiPrint", actionMultiPrint);
         ...
         this.actionMultiPrint.addService(new com.kingdee.eas.framework.client.service.NetFunctionService());
         this.actionMultiPrint.addService(new com.kingdee.eas.framework.client.service.UserMonitorService());
        ...
        getActionManager().registerAction("actionMultiPrintPreview", actionMultiPrintPreview);
         ...
         this.actionMultiPrintPreview.addService(new com.kingdee.eas.framework.client.service.NetFunctionService());
         this.actionMultiPrintPreview.addService(new com.kingdee.eas.framework.client.service.UserMonitorService());
        this.btnAudit = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnUnAudit = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.separatorAudit = new com.kingdee.bos.ctrl.swing.KDSeparator();
        ...
        this.separatorAudit.setName("separatorAudit");
        ...
        // separatorAudit
        // kDSeparator8		
        this.kDSeparator8.setEnabled(false);		
        ...
        this.menuItemMultiPrint.setToolTipText(resHelper.getString("menuItemMultiPrint.toolTipText"));		
        this.menuItemMultiPrint.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_printcontinue"));
        ...
        this.menuItemMultiPrintPreview.setToolTipText(resHelper.getString("menuItemMultiPrintPreview.toolTipText"));		
        this.menuItemMultiPrintPreview.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_printpreview"));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.st.common.app.STBillBaseListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSTBillBaseListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTBillBaseListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionClose extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTBillBaseListUI.this, "ActionClose", "actionClose_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnClose extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTBillBaseListUI.this, "ActionUnClose", "actionUnClose_actionPerformed", e);
        }
    }
    ...
    protected class ActionMultiPrint extends ItemAction {     
		...
		super(uiObject);     
            ...
            String _tempStr = null;
            this.putValue(ItemAction.ACCELERATOR_KEY, KeyStroke.getKeyStroke("shift P"));
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTBillBaseListUI.this, "ActionMultiPrint", "actionMultiPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionMultiPrintPreview extends ItemAction {     
		...
		super(uiObject);     
            ...
            String _tempStr = null;
            this.putValue(ItemAction.ACCELERATOR_KEY, KeyStroke.getKeyStroke("shift alt P"));
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTBillBaseListUI.this, "ActionMultiPrintPreview", "actionMultiPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.st.common.client", "STBillBaseListUI");
    }
