 ...
 * output class name
 */
public abstract class AbstractSTTreeBaseDataDTreeEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSTTreeBaseDataDTreeEditUI.class);
    ...
    protected com.kingdee.eas.st.common.STTreeBaseDataDTreeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSTTreeBaseDataDTreeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSTTreeBaseDataDTreeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.st.common.app.STTreeBaseDataDTreeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.st.common.STTreeBaseDataDTreeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.st.common.client", "STTreeBaseDataDTreeEditUI");
    }
    ...
    {
        return com.kingdee.eas.st.common.client.STTreeBaseDataDEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.st.common.STTreeBaseDataDTreeFactory.getRemoteInstance();
    }
