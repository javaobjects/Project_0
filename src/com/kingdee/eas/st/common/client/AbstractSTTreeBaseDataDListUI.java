 ...
 * output class name
 */
public abstract class AbstractSTTreeBaseDataDListUI extends com.kingdee.eas.basedata.framework.client.DataBaseDTreeDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSTTreeBaseDataDListUI.class);
     ...
     */
    public AbstractSTTreeBaseDataDListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSTTreeBaseDataDListUI.class.getName());
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
    ...
    public void initUIMenuBarLayout()
    {
        ...
        menuEdit.add(menuItemGroupUpgrade);
        menuEdit.add(menuAssignDataBaseD);
        menuEdit.add(menuBatchAssign);
        menuEdit.add(menuViewAssigned);
    ...
    public void initUIToolBarLayout()
    {
        ...
        this.toolBar.add(btnViewAssigned);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.st.common.app.STTreeBaseDataDListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSTTreeBaseDataDListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTTreeBaseDataDListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.st.common.client", "STTreeBaseDataDListUI");
    }
