 ...
 * output class name
 */
public abstract class AbstractSTTreeBaseDataListUI extends com.kingdee.eas.basedata.framework.client.DataBaseSITreeDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSTTreeBaseDataListUI.class);
     ...
     */
    public AbstractSTTreeBaseDataListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSTTreeBaseDataListUI.class.getName());
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.st.common.app.STTreeBaseDataListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSTTreeBaseDataListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTTreeBaseDataListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.st.common.client", "STTreeBaseDataListUI");
    }
