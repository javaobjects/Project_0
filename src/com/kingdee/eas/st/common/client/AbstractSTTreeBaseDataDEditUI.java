 ...
 * output class name
 */
public abstract class AbstractSTTreeBaseDataDEditUI extends com.kingdee.eas.basedata.framework.client.DataBaseDEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSTTreeBaseDataDEditUI.class);
    ...
    protected com.kingdee.eas.st.common.STTreeBaseDataDInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractSTTreeBaseDataDEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSTTreeBaseDataDEditUI.class.getName());
    ...
    public void initUIMenuBarLayout()
    {
        ...
        menuEdit.add(menuItemAudit);
        menuEdit.add(menuItemUnAudit);
        //MenuService
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.st.common.app.STTreeBaseDataDEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.st.common.STTreeBaseDataDInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSTTreeBaseDataDEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSTTreeBaseDataDEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.st.common.client", "STTreeBaseDataDEditUI");
    }
    ...
    {
        return com.kingdee.eas.st.common.STTreeBaseDataFactory.getRemoteInstance();
    }
