...
public class STDataBaseD extends DataBaseD implements ISTDataBaseD
{
    public STDataBaseD()
    {
        super();
        registerInterface(ISTDataBaseD.class, this);
    }
    public STDataBaseD(Context ctx)
    {
        super(ctx);
        registerInterface(ISTDataBaseD.class, this);
    }
    ...
    private STDataBaseDController getController() throws BOSException
    {
        return (STDataBaseDController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSTDataBaseDInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSTDataBaseDInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSTDataBaseDInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSTDataBaseDCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSTDataBaseDCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSTDataBaseDCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
