...
public class STCommonReportFacadeControllerBean extends
		AbstractSTCommonReportFacadeControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.st.common.app.rpt.STCommonReportFacadeControllerBean");
}