...
public class STBillTemplateEntryControllerBean extends
		AbstractSTBillTemplateEntryControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.st.common.template.app.STBillTemplateEntryControllerBean");
}