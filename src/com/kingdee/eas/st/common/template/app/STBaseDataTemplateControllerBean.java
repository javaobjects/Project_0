...
public class STBaseDataTemplateControllerBean extends
		AbstractSTBaseDataTemplateControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.st.common.template.app.STBaseDataTemplateControllerBean");
}