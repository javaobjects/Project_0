 ...
 * output class name
 */
public class STBaseDataTemplateListUI extends AbstractSTBaseDataTemplateListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(STBaseDataTemplateListUI.class);

	/**
	 * output class constructor
	 */
	public STBaseDataTemplateListUI() throws Exception {
		super();
	}
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.st.common.template.STBaseDataTemplateFactory
				.getRemoteInstance();
	}
	...
	protected com.kingdee.bos.dao.IObjectValue createNewData() {
		com.kingdee.eas.st.common.template.STBaseDataTemplateInfo objectValue = new com.kingdee.eas.st.common.template.STBaseDataTemplateInfo();
