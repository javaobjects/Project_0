 ...
 * output class name
 */
public class STBillTemplateListUI extends AbstractSTBillTemplateListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(STBillTemplateListUI.class);

	/**
	 * output class constructor
	 */
	public STBillTemplateListUI() throws Exception {
		super();
	}
