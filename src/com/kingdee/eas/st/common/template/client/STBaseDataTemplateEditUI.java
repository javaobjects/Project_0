 ...
 * output class name
 */
public class STBaseDataTemplateEditUI extends AbstractSTBaseDataTemplateEditUI {
	private static final Logger logger = CoreUIObject
			.getLogger(STBaseDataTemplateEditUI.class);

	/**
	 * output class constructor
	 */
	public STBaseDataTemplateEditUI() throws Exception {
		super();
	}
