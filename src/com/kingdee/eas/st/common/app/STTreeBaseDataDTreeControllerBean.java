...
import com.kingdee.eas.st.common.STTreeBaseDataDFactory;
...
public class STTreeBaseDataDTreeControllerBean extends
		AbstractSTTreeBaseDataDTreeControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.st.common.app.STTreeBaseDataDTreeControllerBean");

	protected void _delete(Context ctx, IObjectPK pk) throws BOSException,
			EASBizException {
		ISTTreeBaseDataD iSTTreeBaseData = STTreeBaseDataDFactory
	...
	protected void _update(Context ctx, IObjectPK pk, IObjectValue model)
		...
		ISTTreeBaseDataD iSTTreeBaseData = STTreeBaseDataDFactory
				.getLocalInstance(ctx);
		STTreeBaseDataDTreeInfo treeBaseInfo = (STTreeBaseDataDTreeInfo) model;
		boolean ok = true;
